...
;	Gui, Add, text, hide x10 ym+270 w560 h60  vEDIT3 hwndhGUI3 ; timeout hide
	Gui, Add, listview, x10 ym+350 w545 h140  vLV1 hwndhLV1, a|b|c|d ; listview
...
guicontrol, hide, edit3 
	...
	setTimer, ^F5, -1 ; ebable debugInfo
...
; thisGuiUpdate := DEBUGINFO() "`n" thisGuiTimeOutDownCounter()
 ...
 thisGuiUpdate := "Aktuelle Zeit: " A_DD "." Month(A_MM) "." a_YYYY " " A_Hour ":" A_Min ":" A_Sec " Uhr"
		...
		MainArray["SonnenstundenCalendarDayLTRIM", DayCounter]  	:= StimeStd ":" StimeMIN
		}
...
isSchaltjahr(AYear) {
;global
return daysInYear := Mod(AYear, 4) || ! Mod(AYear, 100) & Mod(AYear, 400) ? ("Das Jahr: " AYear " hat: " 365 " Tage ( kein Schaltjahr ) " NextSchaltjahrDIGIT()) : ("Das Jahr: " AYear " hat: " 366 " Tage ( Schaltjahr )" NextSchaltjahrDIGIT())
}
...
if schaltjahr 
return daysInYear := Mod(AYear, 4) || ! Mod(AYear, 100) & Mod(AYear, 400) ? (0) : ("[ Next: " AYear " ]")
}}
;////////////////////////////////////////////////////////////////////////////////////////////////////////
DEBUGINFO() {
global
if showDebuginfo
return "DEBUGinfo: RISE#: " MainArray["thisRISECounter"] 
