...
;    Gui,1:Add, text,x%x% y%y% w%w% vTextEdit1 hwndhTextEdit1 center section gGeplanteTrigger ,% A_DDDD a_space A_DD "." Month(A_MM) "." a_YYYY "  " A_Hour ":" A_Min ":" A_Sec " Uhr" ; timestamp
     Gui,1:Add, text,x%x% y%y% w%w% vTextEdit1 hwndhTextEdit1 center section gListViewEinUndAusblenden  ,% A_DDDD a_space A_DD "." Month(A_MM) "." a_YYYY "  " A_Hour ":" A_Min ":" A_Sec " Uhr" ; timestamp
	;-
...
Gui,1:Font, s%fs11% normal,											;		Wiederholen
...
; ////////////////////////////////////////////////////////////////////////////////////	GroupBox Geplante Trigger: (über listview1) 
	...
	Gui,1: Font,									% thisZoomFactorNormal(11)
...
; ////////////////////////////////////////////////////////////////////////////////////	button Übernehmen
	...
	Gui,1: Font,									% thisZoomFactorBold(10)
...
; ////////////////////////////////////////////////////////////////////////////////////	text Nächste System Aktion
	...
	Gui,1: Font,									% thisZoomFactorNormal(11)
	GuiControl,1:    MoveDraw, 		NächsteGeplanteSystemAction,		% thisX(2.5) thisY(49.5) thisW(26) thisH(2.2) ;  default
...
; ////////////////////////////////////////////////////////////////////////////////////  LOG ListView LV1
	...
	Gui,1: Add, listview, vLV1 hwndhLV1 grid background%color% cBlack Hidden	
									, Timestamp|ThisLabel|Name|ThisFunc|ThisHotkey|PriorHotkey|PriorKey|TimeSinceThisHotkey|TimeSincePriorHotkey|GuiControl|GuiEvent|EventInfo
