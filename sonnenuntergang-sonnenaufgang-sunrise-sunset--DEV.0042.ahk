...
Sonnenuntergang:	16.Nov.2023  16:18:55:461 Uhr	F2	Sonnenuntergang [ 1 ]	thisSET	F2	empty	F2	00:00:00	00:00:00	empty	empty	empty
...
;	Gui,1: Font,							% thisZoomFactorBold(16.01) " cBlack", Verdana
	GuiControl,1:    MoveDraw, 		ActiveXA,		% thisX(30) thisY(5) thisW(34) thisH(73) ;  default
;	GuiControl,1:    Font, 			ActiveXA
;	GuiControl,1: ,  			ActiveXA, 		% "mshtml:<img src='" pic "' />" 
...
; ////////////////////////////////////////////////////////////////////////////////////	text TextEdit1 TimeStamp
	...
	Gui,1: Font,							% thisZoomFactorBold(15.01) " cBlue", Verdana 
	GuiControl,1:    MoveDraw, 		TextEdit1,		% thisX(1) thisY(1.5) thisW(29) thisH(2.6) ;  default
...
; ////////////////////////////////////////////////////////////////////////////////////	Sonnen Edit Stunden
	...
	Gui,1: Add, edit , 	vSonnenEditStunden gSonnenEditStunden hwndhSsonnenEditStunden center ; BackgroundTrans 
	Gui,1: Font,							% thisZoomFactorNormal(10.01)
	GuiControl,1:    MoveDraw, 		SonnenEditStunden,	% thisX(1.1) thisY(5.0) thisW(2.3) thisH(2.2) ;  default
...
;	GuiControl,1:    enable, 		SonnenEditStunden
	Gui, Add, UpDown, vSonnenEditStundenUpDown Horz 16 Range0-23, 0									;		Wiederholen
...
;Gui, Color, silver
	...
	Gui,1: Add, text , 	vTextStunden cBLUE Hidden		
	Gui,1: Font,							% thisZoomFactorNormal(10.01)
	GuiControl,1:    MoveDraw, 		TextStunden,		% thisX(5.1) thisY(5.45) thisW(2.9) thisH(2) ;  default
...
; ////////////////////////////////////////////////////////////////////////////////////	Sonnen Edi tMinuten
	...
	Gui,1: Add, edit ,  vSonnenEditMinuten gSonnenEditMinuten hwndhSsonnenEditMinuten Hidden center
	Gui,1: Font,							% thisZoomFactorNormal(10.01)
	GuiControl,1:    MoveDraw, 		SonnenEditMinuten,	% thisX(8.8) thisY(5) thisW(2.3) thisH(2.2) ;  default
...
;	GuiControl,1:    enable, 		SonnenEditMinuten
	Gui, Add, UpDown, vSonnenEditMinutenUpDown Horz 16 Range00-59, 02									;		Wiederholen
	GuiControl,1:    MoveDraw, 		SonnenEditMinutenUpDown, 			% thisW(2.2) thish(2.20)
; ////////////////////////////////////////////////////////////////////////////////////	GroupBox LOG: 
	if MaßNehmen
	Gui,1: Add, text , 0x1000 vTextMinuten ; Maß nehmen
	else
	Gui,1: Add, text , 	vTextMinuten cBLUE Hidden		
	Gui,1: Font,							% thisZoomFactorNormal(10.01)
	GuiControl,1:    MoveDraw, 		TextMinuten,		% thisX(12.8) thisY(5.45) thisW(3.3) thisH(2) ;  default
...
; ////////////////////////////////////////////////////////////////////////////////////	ddl1 Trigger auswählen...
	...
	Gui,1: Font,							% thisZoomFactorNormal(10.01)
	GuiControl,1:    MoveDraw, 		ddl1, 			% thisX(16.7) thisY(5) thisW(12.3) ; thisH(2.5) ;  default
...
; ////////////////////////////////////////////////////////////////////////////////////	ddl3 Trigger Datei auswählen...
	...
	Gui,1:Add, DDL, r21 vddl3 hwndhDDL3 choose1, 			%a_space%Trigger Datei auswählen...
	Gui,1: Font,							% thisZoomFactorNormal(9.711) 
	GuiControl,1:    MoveDraw, 		ddl3, 			% thisX(1.0) thisY(8.5) thisW(28.0) ; thisH(2.5) ;  default
...
; ////////////////////////////////////////////////////////////////////////////////////	GroupBoxA Wiederholen (radios)
	...
	Gui,1: Font,									% thisZoomFactorNormal(9.711) ; " cFF9977"
...
; ////////////////////////////////////////////////////////////////////////////////////	radio täglich										;		Wiederholen
	...
	Gui,1: Font,									% thisZoomFactorNormal(9.711) ; "cRed"
...
;	Gui,1: Add, ComboBox, vtriggerSuche , Rot|Grün|Blau|Schwarz|Weiß
	Gui,1: Font,									% thisZoomFactorNormal(10.51) 
...
;	GuiControl,1:    , 	 +cBlue,	ListViewAnsichErweitern
;	GuiControl,1: 	+BackgroundFF9977, 	ListViewAnsichErweitern
;	Gui,1: Add, Progress,   Disabled BackgroundSilver	vThisProgress#1a
;	GuiControl,1:    MoveDraw, 		ThisProgress#1a,			% thisX(14.5) thisY(18.0) thisW(7.5) thisH(2.6) ;  default
; ////////////////////////////////////////////////////////////////////////////////////	button Übernehmen
	if MaßNehmen
	Gui,1: Add, text , 0x1000 vÜbernehmen	; Maß nehmen
	else
	Gui,1:Add, button, vÜbernehmen hwndHÜbernehmen Hidden 
	Gui,1: Font,									% thisZoomFactorNormal(9.011)
...
;	GuiControl,1: 	+BackgroundFF9977, 	LV1
; ////////////////////////////////////////////////////////////////////////////////////
...
;	setTimer, RadioRnRoll, -1
	...
	GuiControl,1:    show, 			LV1 												;  ElseListViewEinUndAusblenden 1080
	GuiControl,1: 	+cBlue, RadioEinmal
	GuiControl,1: 	+cBlue, RadioTäglich
	GuiControl,1: 	+cBlue, RadioWöchendlich
	GuiControl,1: 	+cBlue, RadioMonatlich
