...
*/
	...
	RISEfile := "K:\_desktop\screenshot all\screenshot 2 -direktauslösend.ahk"

	; Bei Sonnenuntergang wird SETfile gestartet
	SETfile  := "K:\_desktop\screenshot all\screenshot 2 -direktauslösend.ahk"
	...
	Gui, Font, 	s12
	Gui, Add, text, xs y+13 w550 h200 vEDIT1, A
	Gui, Show, x110 y11 w555 h205,% hGUIA  
	return
...
start:
 ...
 if !MakeList
 thisToolTip := "Aktuelle Zeit: " A_DD "." Month(A_MM) "." a_YYYY "  " A_Hour ":" A_Min ":" A_Sec " Uhr"
...
F3:
ToggleToolTip := (ToggleToolTip:=!ToggleToolTip)
return

toolTip:
if ToggleToolTip
{
GuiControl,, EDIT1, %thistoolTip%
;tooltip,% thistoolTip
} else
ToolTip
return
...
thisRISE(RISEfile) {
	...
	return " `tSUNRISE"
		...
		thisRISECounter++
		if !ToggleToolTip
		ToolTipTimeout(.1) ; .1 ist 6 sekunden
		return " `tSUNRISE"
}
