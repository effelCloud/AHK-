...
Halbe_Zeit_Last_Next_Sonnenuntergang:	27.Nov.2023  04:34:00:501 Uhr	start	Halbe_Zeit_Last_Next_Sonnenuntergang (System) [  ]	SonnenuntergangNaechsterInIstLetzterVor	empty	empty	v	00:00:00	00:00:00	empty	empty	empty
...
Halbe_Zeit_Last_Next_Sonnenaufgang:	27.Nov.2023  08:04:03:235 Uhr	start	Halbe_Zeit_Last_Next_Sonnenaufgang (System) [  ]	SonnenaufgangNaechsterInIstLetzterVor	empty	empty	Enter	00:00:00	00:00:00	empty	empty	empty
Halbe_Zeit_Last_Next_Sonnenaufgang:	27.Nov.2023  08:04:05:669 Uhr	start	Halbe_Zeit_Last_Next_Sonnenaufgang (System) [  ]	SonnenaufgangNaechsterInIstLetzterVor	empty	empty	Enter	00:00:00	00:00:00	empty	empty	empty
...
Halbe_Zeit_Last_Next_Sonnenuntergang:	27.Nov.2023  16:34:02:788 Uhr	start	Halbe_Zeit_Last_Next_Sonnenuntergang (System) [ 1 ]	SonnenuntergangNaechsterInIstLetzterVor	empty	empty	empty	00:00:00	00:00:00	empty	empty	empty
Halbe_Zeit_Last_Next_Sonnenuntergang:	27.Nov.2023  16:34:05:119 Uhr	start	Halbe_Zeit_Last_Next_Sonnenuntergang (System) [ 1 ]	SonnenuntergangNaechsterInIstLetzterVor	empty	empty	empty	00:00:00	00:00:00	empty	empty	empty
Halbe_Zeit_Last_Next_Sonnenaufgang:	27.Nov.2023  20:04:00:565 Uhr	start	Halbe_Zeit_Last_Next_Sonnenaufgang (System) [ 1 ]	SonnenaufgangNaechsterInIstLetzterVor	empty	empty	,	00:00:00	00:00:00	empty	empty	empty
...
; ////////////////////////////////////////////////////////////////////////////////////	GroupBox Geplante Trigger: (über listview1) 
	if MaßNehmen
	Gui,1: Add, text , 0x1000 vGroupBoxÜberListView1 cBlue , vGroupBoxÜberListView1  ; Maß nehmen
	else
...
; ////////////////////////////////////////////////////////////////////////////////////	vTextMinuten 
	...
	TextMinuten_TT := "`nGui,1: Add, text , vTextMinuten cBLUE Hidden`n" a_space "a_LineNumber: " a_lineNumber
	Gui,1: Font,							% thisZoomFactorNormal(9.01)
...
; ////////////////////////////////////////////////////////////////////////////////////	ddl1 Trigger auswählen...
	...
	Gui,1:Add, DDL, vddl1 hwndhDDL1 choose1, 	%a_space%Trigger auswählen... 
								| vor Sonnenaufgang
								| nach Sonnenaufgang Sonnenaufgang 
								| vor Sonnenuntergang
...
;loop, 27 {
;if (a_index>1)
;  Gui, Add, DropDownList,%     "y20 x192 0x400 cBlue r27 W" rand " hwndHSearchFieldInclude" (A_index + 0) " vSearchFieldInclude" (A_index + 0) " choose" 1,%  DDLList#1
; SendMessage, CB_SETDROPPEDWIDTH, 150, 0, ,% "ahk_id HSearchFieldInclude" a_index
; SendMessage, CB_SETDROPPEDWIDTH, 150, 0, , ahk_id HSearchFieldInclude%a_index%
; HSearchField := HSearchFieldInclude%a_index%
;  SendMessage, CB_SETDROPPEDWIDTH, 150, 0, , ahk_id %HSearchField%
;}
...
;	GuiControl,1:    +BackgroundGreen,	TextInGroupBoxSonnenstunden
	...
	GuiControl,1:    +BackgroundTrans, 	TextInGroupBoxSonnenstunden
; ////////////////////////////////////////////////////////////////////////////////////	GroupBox winterzeit unter Sonnenstunden GroupBoxUnterSonnenstunden
	if MaßNehmen || MaßNehmen1264
...
; ////////////////////////////////////////////////////////////////////////////////////	counteranzeige neben "historie ansicht erweitern" MainArray["thisRISECounter"]
	...
	Gui,1: Add, text , 	vRiseCounterGUIanzeige center
...
; ////////////////////////////////////////////////////////////////////////////////////	counteranzeige neben "historie ansicht erweitern" MainArray["thisSETCounter"]
	...
	Gui,1: Add, text , 	vSetCounterGUIanzeige center
	Gui,1: Font,									% thisZoomFactorBold(16.654321)
...
;	ControlGet, AusgabeVar, Hwnd ,, Steuerelement, FensterTitel, FensterText, AusnahmeTitel, AusnahmeText
	Gui +LastFound
	ControlGet, thisHWND, Hwnd ,,,% x ; thisMsgBox ; % a_ScriptName ; FensterTitel
	WinGetPos, MsgBoxX, MsgBoxY, MsgBoxWidth, MsgBoxHoehe,% "ahk_id " thisHWND
	msgbox,% clipboard := 	  MsgBoxx "`n"
				. MsgBoxy "`n"
				. MsgBoxWidth "`n"
...
; /////////////////////////////////////////////////////////////////////////////////////
		...
		if !inStr(bigLife24stdLast, A_DDDD A_SPACE A_DD A_SPACE Month(A_MM) A_SPACE a_YYYY A_SPACE A_Hour A_SPACE A_Min)
		{
		...
		. MainArray["Stunden bis zum nächsten Sonnenaufgang"]
		. MainArray["Minuten bis zum nächsten Sonnenaufgang"]  a_tab
		. MainArray["Stunden seit letztem Sonnenaufgang"]
		. MainArray["Minuten seit letztem Sonnenaufgang"]  a_tab
		. MainArray["Sonnenuntergang"] a_tab
		. MainArray["Stunden bis zum nächsten Sonnenuntergang"]
		. MainArray["Minuten bis zum nächsten Sonnenuntergang"]  a_tab	
		. MainArray["Stunden seit letztem Sonnenuntergang"]
		. MainArray["Minuten seit letztem Sonnenuntergang"]  a_tab
		. MainArray["SonnenstundenCalendarDayLTRIM", A_YDay] a_tab
		. StimeStd ":" StimeMINNoLTRIM a_tab
		. TagNachtZeiten() a_tab
		. xAuf  a_tab
		. xUnter  "`n"

		filename := 	 "MinutenLogFilefuer24std - " a_YYYY "." A_MM "." A_DD 
		. A_SPACE A_DDDD A_SPACE A_DD A_SPACE Month(A_MM) A_SPACE a_YYYY ".csv"
...
if !inStr(SonnenaufgangNaechsterInIstLetzterVorall, A_DD "." Month(A_MM) "." a_YYYY " Sonnenaufgang " A_Hour ":" A_Min) ; && (A_ThisLabel="start") { ; nur ein System trigger täglich möglich
	...
	return (init 
		?   SonnenaufgangNaechsterInIstLetzterVorCounter := 1
...
if !inStr(SonnenuntergangNaechsterInIstLetzterVorall, A_DD "." Month(A_MM) "." a_YYYY " Sonnenuntergang " A_Hour ":" A_Min) ; && (A_ThisLabel="start") { ; nur ein System trigger täglich möglich
	...
	return (init 
		?   SonnenuntergangNaechsterInIstLetzterVorCounter := 1
...
; wenn der user auslösetaste betätigt hat, kann der trigger nach diesem zeitpunkt nur einmal vom System gesetzt werden
	...
	if !inStr(timeStampRISEall, A_DD "." Month(A_MM) "." a_YYYY " Sonnenaufgang " A_Hour ":" A_Min) && (A_ThisLabel="start") {			; nur ein System trigger täglich möglich
		...
		MainArray["thisRISECounter"] := thisF1Counter 
		try run,% RISEfile,, hide, AusgabeVarPID
...
WM_MOUSEMOVE()
{
    ...
    ToolTip % %AktStrlmnt%_TT  ; Das Prozentzeichen am Anfang erzwingt einen Ausdruck.
