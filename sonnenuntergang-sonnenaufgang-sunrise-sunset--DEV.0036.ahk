...
Gui, Font, s%fs11% normal,
 ...
 gui,show,x-1650 y%y% w%w% h%h% ,TEST	
...
settimer, showhideListView1, 1500
...
return
 x:=(wa*4.5)/xx,	y:=(ha*43.5)/xx
 GuiControl,1: move, ListViewEinUndAusblenden, x%x% y%y% 
GuiControl,1: hide, GroupBoxÜberListView1
GuiControl,1: hide, GroupBoxUnterListView1

; x:=(wa*4.5)/xx,	y:=(ha*43.5)/xx
  x:=(wa*1)/xx,	y:=(ha*23)/xx,	w:=(wa*28)/xx,	h:=(ha*30)/xx
  GuiControl,1: move, ListView1, x%x% y%y% h%h%
; GuiControl,1: hide, ListView1

GuiControl,1: hide, LV1
sleep, 500
 x:=(wa*3.5)/xx,	y:=(ha*43.5)/xx
 GuiControl,1: move, ListViewEinUndAusblenden, x%x% y%y% 
...
;msgbox % AusgabeVar
; /////////////////////////////////////////////////////////////////////////////////////
	thisNextScheduledAction := strReplace(MainArray["nextScheduledAction"],"  ",a_space)
	if !(LastNextScheduledAction=thisNextScheduledAction)
	GuiControl,, NächsteGeplanteAction,% thisNextScheduledAction
