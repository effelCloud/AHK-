...
fileAppend,% LoadLogHistory(), a_scriptDir "\" A_ScriptName " timeStampall.txt"
LoadLogHistory() {
return thisLogFile=
(
...
Gefahrenmeldung:	30.Okt.2023  01:22:44:963 Uhr	F10	Sturmwarnung	thisGefahrenmeldung	F10	empty	empty	00:00:00	00:00:00	empty	empty	empty
...
;	fileRead, thisReloadtimeStamp,  % a_scriptDir "\" A_ScriptName " timeStampall.txt"
	thisLoadLogHistory := LoadLogHistory()
	Loop, parse, thisLoadLogHistory,`n
	{
	split := strSplit(a_loopfield,a_tab)
	if a_loopfield {
	LV_Modify(LV_Add("", split.2, split.3, split.4 , split.5, split.6, split.7, split.8, split.9, split.10, split.11, split.12), "Vis")
...
LoadLogHistory() {
return Scripts := ["Programmstart:	28.Okt.2023  05:20:12:553 Uhr	empty	Programmstart	empty	empty	empty	empty	00:00:00	00:00:00	empty	empty	empty"
, "Sonnenaufgang:	28.Okt.2023  08:15:00:801 Uhr	start	Sonnenaufgang [ 1 ]	thisRISE	empty	empty	empty	00:00:00	00:00:00	empty	empty	empty"
, "Sonnenuntergang:	28.Okt.2023  18:16:00:653 Uhr	start	Sonnenuntergang [ 1 ]	thisSET	F1	^F10	Delete	03:31:48	03:45:04	empty	empty	empty"
, "Sondermeldung:	29.Okt.2023  00:00:05:929 Uhr	Hinweis	Beginn: Winterzeit [ MEZ ]	empty	empty	empty	empty	00:00:00	00:00:00	empty	empty	empty"
, "Sonnenaufgang:	29.Okt.2023  07:16:00:567 Uhr	start	Sonnenaufgang [ 1 ]	thisRISE	empty	empty	empty	00:00:00	00:00:00	empty	empty	empty"
...
, "Sonnenuntergang:	31.Okt.2023  17:11:00:368 Uhr	start	Sonnenuntergang [ 1 ]	thisSET	F4	F4	empty	04:32:41	05:32:41	empty	empty	empty"]
	...
	MKPic := 1 			;  = screenshot um mitternacht
...
;	Gui, Add, text, hide x10 ym+270 w560 h60  vEDIT3 hwndhGUI3 ; timeout hide
	Gui, Font, s10	norm 
	Gui, Add, listview, x10 	ym+390 	w545 h400  vLV1 hwndhLV1 grid, Timestamp|ThisLabel|Name|ThisFunc|ThisHotkey|PriorHotkey|PriorKey|TimeSinceThisHotkey|TimeSincePriorHotkey|GuiControl|GuiEvent|EventInfo
	Gui, Add, listview, x610 	ym+60 	w610 h300  vLV2 hwndhLV2 grid, Tag|Datum|Sonnenaufgang|Sonnenuntergang|Sonnenstunden|SonnenstundenSpeak
...
Gui, ListView, LV2
	...
	if (a_index=1)
	continue
	LV_Modify(LV_Add("", ((a_index=1) ? ("") : (a_index-1)), split.1, split.2, split.3, split.4, split.5, split.6), "Vis")
...
Gui, listview, default
 ; https://www.autohotkey.com/boards/viewtopic.php?p=387116&   <>  ListView nach GUIstart Focus 'anspringen'
...
return MainArray["TagNachtZeit"] := "Nachmittagzeit 15 bis 18 Uhr"
if (Ahour>=13) && (Ahour<=14)
return MainArray["TagNachtZeit"] := "Mittagzeit 13 bis 15 Uhr"
if (Ahour>=11) && (Ahour<=12)
return MainArray["TagNachtZeit"] := "Vormittagzeit 11 bis 13 Uhr"
...
return MainArray["TagNachtZeit"] := "Nachmittagzeit 14 bis 17 Uhr"
if (Ahour>=12) && (Ahour<=13)
return MainArray["TagNachtZeit"] := "Mittagzeit 12 bis 14 Uhr"
if (Ahour>=10) && (Ahour<=11)
return MainArray["TagNachtZeit"] := "Vormittagzeit 10 bis 12 Uhr"
