...
LoadThisCcontrols := 0  ; alle controls ins clipboard laden, hilfe für button [ansicht erweitern]
...
Gui,1:Font, s%fs10% normal,
	...
	Gui,1:Add, edit, x%x% y%y% w%w% h%h% vSonnenEditStunden hwndhSsonnenEditStunden center, 00
	;-
Gui,1:Font, s%fs10% normal,
...
Gui,1:Font, s%fs10% normal,
	...
	Gui,1:Add, edit, x%x% y%y% w%w% h%h%  vSonnenEditMinuten hwndhSsonnenEditMinuten center, 02
	;-
Gui,1:Font, s%fs10% normal,
...
; ////////////////////////////////////////////////////////////////////////////////////	edit triggerSuche											;		Wiederholen
	if MaßNehmen
	Gui,1: Add, text , 0x1000 vtriggerSuche ; Maß nehmen
	else
	Gui,1: Add, edit, vtriggerSuche -WantReturn
;	Gui,1: Add, ComboBox, vtriggerSuche  , Rot|Grün|Blau|Schwarz|Weiß
	Gui,1: Font,									% thisZoomFactorNormal(11.01) 
	GuiControl,1:    MoveDraw, 		triggerSuche, 				% thisX(1.5) thisY(18.0) thisW(12.0) thisH(2.6) ;  default
	GuiControl,1:    Font, 			triggerSuche
	GuiControl,1: ,  triggerSuche, 							TriggerSuche
...
; ////////////////////////////////////////////////////////////////////////////////////	button ListView (oben) AnsichErweitern
	...
	Gui,1: Font,									% thisZoomFactorNormal(9.71) 
...
;	color=D4D0C8 
	...
	Gui,1: Add, listview, vListView1 hwndhListView1 grid background%ListView1Color% cBlack Hidden  +Checked	
									, HH
									 ...
									 |Trigger
									 |Trigger File
	LV_ModifyCol(1,(wa*3)/xx)
	LV_ModifyCol(2,(wa*3)/xx)
	LV_ModifyCol(3,(wa*6)/xx)
	LV_ModifyCol(4,(wa*13.5)/xx)

	Gui,1: Font,									% thisZoomFactorNormal(9.51)
...
; ////////////////////////////////////////////////////////////////////////////////////  ListView LOG LV1
	...
	Gui,1: Add, listview, vLV1 hwndhLV1 grid background%LV1Color% cBlack Hidden  +Checked	
									, Timestamp
									 |ThisLabel
									 |Name
									 |ThisFunc
...
if !ListViewEinUndAusblenden
{
	...
	GuiControl,1:    hide, 			LV1											; ListViewEinUndAusblenden 1080
	GuiControl,1: ,  ListViewAnsichErweitern, 							Hauptmenü			; ListViewEinUndAusblenden 1080
	...
	GuiControl,1:    MoveDraw, 		mehr,					% thisX(25.0) thisY(43.5) thisW(3.5) thisH(2.6)		;  ElseListViewEinUndAusblenden
	GuiControl,1:    MoveDraw, 		MarkierteLöschen,			% thisX(17.1) thisY(43.5) thisW(7.6) thisH(2.6) 	;  ElseListViewEinUndAusblenden
	GuiControl,1:    MoveDraw, 		ListeExportieren,			% thisX(9.3) thisY(43.5) thisW(7.4) thisH(2.6) 		;  ElseListViewEinUndAusblenden
	GuiControl,1:    MoveDraw, 		ListeImportieren,			% thisX(1.5) thisY(43.5) thisW(7.4) thisH(2.6)		;  ElseListViewEinUndAusblenden
	GuiControl,1:    MoveDraw, 		GroupBoxUnterListView1,			% thisX(1.0) thisY(42.0) thisW(28.0) thisH(4.8) 	;  ElseListViewEinUndAusblenden
	GuiControl,1:    MoveDraw, 		ListView1, 				% thisX(1.0) thisY(23.0) thisW(28.0) thisH(20.0) 	;  ElseListViewEinUndAusblenden
	GuiControl,1: ,  ListViewAnsichErweitern, 							Ansicht erweitern
	GuiControl,1:    show, 			GroupBoxÜberListView1 										;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			Übernehmen 											;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			GroupBoxUnterListView1 										;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			mehr 												;  ElseListViewEinUndAusblenden										;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			MarkierteLöschen 										;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			ListeExportieren 										;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			ListeImportieren 										;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			GroupBoxNächsteSystemAktion 									;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			NächsteGeplanteSystemAction 									;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			GroupBoxLOG 											;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			GroupBoxUnterLOGListview 									;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			LogListeExportieren 										;  ElseListViewEinUndAusblenden
	GuiControl,1:    show, 			LV1 												;  ElseListViewEinUndAusblenden
}
return
