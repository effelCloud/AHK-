...
; ////////////////////////////////////////////////////////////////////////////////////	text unter GroupBox Sonnenstunden GroupBoxSonnenstunden
	...
	Gui,1: Font,									% thisZoomFactorBold(14.6111)  ; (22.5111)
	GuiControl,1:    MoveDraw, 		TextInGroupBoxSonnenstunden,		% thisX(30.5900) thisY(32.5)  thisW(34.0) thisH(14.1) ;  default (31.5900) 
...
;	GuiControl,1:    enable, 		TextInGroupBoxSonnenstunden
	...
	GuiControl,1:    +cGreen,	TextInGroupBoxSonnenstunden
...
; /////////////////////////////////////////////////////////////////////////////////////	updateGuiControl 	thisUpdate		Nächste System Aktion [NächsteGeplanteSystemAction]
	...
	thisSonnenstunden  := "[ gestern: " MainArray["SonnenstundenCalendarDayLTRIM", A_YDay-1] " ]`t`t" MainArray["Sonnenstunden"] " Stunden " MainArray["Sonnenminuten"]
	GuiControl,1: ,  			GroupBoxSonnenstunden,					% " Sonnenstunden " MainArray["Sonnenstunden"] " Stunden " MainArray["Sonnenminuten"]
...
;		MainArray["SonnenstundenCalendarDayLTRIM", A_YDay]  := StimeStd ":" StimeMINNoLTRIM ; A_YDay-1
	...
	GuiControl,1: ,  			TextInGroupBoxSonnenstunden,	%  "Tag: " MainArray["isSchaltjahr_dann_ab_28_februar_A_day_plus_eins"] "`n"
										. isSchaltjahr(A_Year) "`n" 
										.  JahresZeitSommerOderWinterZeit() " <> " 
										. TagNachtZeiten()
									;	. MainArray["isSchaltjahr_dann_ab_28_februar_A_day_plus_eins"] "`n" 
...
return 	(IsSummerTime(A_YYYY A_MM A_DD)=1) 
	...
	: "MEZ bis " SubStr(LastSunday(A_YYYY "03"), 7, 2) "." Month(SubStr(LastSunday(A_YYYY "03"), 5, 2)) " <> "
	. "MESZ bis " SubStr(LastSunday(A_YYYY "10"), 7, 2) "." Month(SubStr(LastSunday(A_YYYY "10"), 5, 2)) 
}
