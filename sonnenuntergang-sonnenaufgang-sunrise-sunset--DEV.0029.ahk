...
;	Gui NEW
	...
	Gui -DPIScale
	Gui, add, tab3, vTab3 choose1, 1|2|3
	Gui, Tab
		
	Gui, Add, text, x10 ym0 w560 h30  vEDIT2 hwndhGUI2 center cblue ; timestamp
	Gui, Add, text, x10 ym+40 w600 h340 vEDIT1 hwndhGUIA  
;	Gui, Add, listview, x10 ym+390 	w545 r7  vLV1 hwndhLV1 grid, Timestamp|ThisLabel|Name|ThisFunc|ThisHotkey|PriorHotkey|PriorKey|TimeSinceThisHotkey|TimeSincePriorHotkey|GuiControl|GuiEvent|EventInfo
	Gui, Add, listview, x610 ym+60 	w610 r7 vLV2 hwndhLV2 grid, Tag|Datum|Sonnenaufgang|Sonnenuntergang|Sonnenstunden|SonnenstundenSpeak
guicontrol, hide, edit1 
guicontrol, hide, edit2 
;guicontrol, hide, lv1
guicontrol, hide, lv2

	Gui, Add, text, x10 y0 w1 h30 vTextEdit1 hwndhTextEdit1 center cblue  section ; timestamp
	...
	Gui, Add, edit, x+20 ys+50 w30 vSonnenEditStunden hwndhSsonnenEditStunden section center Range01-24, 00
	Gui, Add, text, xs+40 ys+5 w30  , Stunden				
	Gui, Add, edit, xs+120 ys+0 w30 vSonnenEditMinuten hwndhSsonnenEditMinuten center Range00-59, 59
	Gui, Add, text, xs+160 ys+5 w30  , Minuten
	Gui, Add, DropDownList, xs+240 ys+0 w200 r5 section vddl1 choose1, Trigger auswählen...
								| vor Sonnenaufgang
								| nach Sonnenaufgang
								| vor Sonnenuntergang
	...
	Gui, Add, radio, x30 ym+130 w30 vRadioEinmal , einmal
	Gui, Add, radio, xm+100 ym+130 w30 vRadioTäglich , täglich
	Gui, Add, button, vButtonAdd gButtonAdd xm210 ym+130 w30  , Hinzufügen


	Gui, Add, listview, x10 ym+170 	w545 r8  vListView1 hwndhListView1 grid, HH|MM|Trigger|Trigger File
...
;	Gui, Add, edit, x20 ys+110 w230 h100 vscheduleThisTriggerFile ,test

;	Gui, Add, DateTime, xs+240 ys+30 w100 vMeinDateTime , Time
;	Gui, Add, DateTime, xs+240 ys+30 w60 vMeinDateTime , HH:MM
;	GuiControl, , MeinDateTime, HH:MM
...
x:=(wa*10)/xx,y:=(ha*10)/xx,w:=(wa*30)/xx,h:=(ha*80)/xx
