...
; ////////////////////////////////////////////////////////////////////////////////////	text TextEdit1 TimeStamp
	...
	Gui,1: Font,							% thisZoomFactorBold(20.5111) " cBlue", Verdana ; zoomf (22.5111) (15.01) 
...
; ////////////////////////////////////////////////////////////////////////////////////	button Progress ListView (oben) AnsichErweitern
; Gui +OwnDialogs
;	Progress, 	vthisListViewAnsichtErweiternProgress hwndHthisListViewAnsichtErweiternProgress ; cbRed ctRed cwRed
;	Gui,1: Add, Progress, 	vthisListViewAnsichtErweiternProgress hwndHthisListViewAnsichtErweiternProgress  cbRed ctRed cwRed, test, test, test
	Gui,1: Add, Progress, 	vthisListViewAnsichtErweiternProgress hwndHthisListViewAnsichtErweiternProgress
;	Gui,1: Add, Progress, 	vthisListViewAnsichtErweiternProgress hwndHthisListViewAnsichtErweiternProgress ; cbRed ctRed cwRed
;	Gui,1: Add, Progress,   vthisListViewAnsichtErweiternProgress hwndHthisListViewAnsichtErweiternProgress  cbRed ct900000 cw900000 , cbRed ct900000 cw900000 BackgroundYellow 
;	Gui,1: Add, Progress,   vthisListViewAnsichtErweiternProgress hwndHthisListViewAnsichtErweiternProgress  cbRed ct900000 cw900000 , cbRed ct900000 cw900000 BackgroundYellow 
...
;	Control ExStyle, +0x20000,, % "ahk_id" HthisListViewAnsichtErweiternProgress ; test
	...
	GuiControl,1:    MoveDraw, 		thisListViewAnsichtErweiternProgress,			% thisX(14.4) thisY(17.9) thisW(7.8) thisH(2.9) ;  default
;	Gui,1: Font,											% thisZoomFactorBold(20.011) " cBlack "
;	GuiControl,1:    Font, 			thisListViewAnsichtErweiternProgress
;	GuiControl,1: ,  thisListViewAnsichtErweiternProgress, 						44
	GuiControl,1:    show, 			thisListViewAnsichtErweiternProgress

	GuiControl,1:    hide, 			thisListViewAnsichtErweiternProgress

;	GuiControl,1:    focus, 		thisListViewAnsichtErweiternProgress
	GuiControl,1:    disable, 		thisListViewAnsichtErweiternProgress
;	GuiControl,1:    enable, 		thisListViewAnsichtErweiternProgress
;	GuiControl,1:    ,B2 ,			thisListViewAnsichtErweiternProgress
;	GuiControl,1:   +cBlue,			thisListViewAnsichtErweiternProgress
;	GuiControl,1:    +cbRed +ctRed +cwRed ,	thisListViewAnsichtErweiternProgress
;	GuiControl,1:    +cbRed +ctRed +cwRed ,	thisListViewAnsichtErweiternProgress
;	GuiControl,1: 	+BackgroundSilver , 	thisListViewAnsichtErweiternProgress
;	GuiControl,1: 	+BackgroundFF9977, 	thisListViewAnsichtErweiternProgress
	GuiControl,1: 	+BackgroundRed, 	thisListViewAnsichtErweiternProgress
;	GuiControl,1: 	+Background900000, 	thisListViewAnsichtErweiternProgress
; Gui -OwnDialogs
...
;	GuiControl,1: 	+BackgroundFF9977, 	LV1
	GuiControl,1: 	+cBlack, 		LV1
;schriftFarbe := "blue"
if (schriftFarbe = "blue")
	GuiControl,1: 	+cBlue, 		LV1
else
	GuiControl,1: 	+c%thisCcolor%, 	LV1
; ////////////////////////////////////////////////////////////////////////////////////
