...
fileAppend,% LoadLogHistory() "`n", a_scriptDir "\" A_ScriptName " timeStampall.txt"
fileAppend,% 	"`n", a_scriptDir "\" A_ScriptName " timeStampall.txt"
LoadLogHistory() {
return thisLogFile=
(
...
*/
		...
		LVModifyCol()
		fileAppend,% "`nProgrammstart:`t" A_DD "." Month(A_MM) "." a_YYYY "  " A_Hour ":" A_Min ":" A_Sec ":" A_MSec " Uhr`t"
							. "empty`t"
							. "Programmstart`t"
