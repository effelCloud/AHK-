...
;	Gui,1:Add, text, x%x% y%y%  , Trigger:
	;-
Gui,1:Font, s%fs10% normal,
	x:=(wa*1.1)/xx,y:=(ha*5)/xx,w:=(wa*2.6)/xx,h:=(ha*2.2)/xx
	...
	GuiControl,1:    MoveDraw, 		SonnenEditStundenUpDown, 			% thisW(2.9)
	;-
Gui,1:Font, s%fs10% normal,
	x:=(wa*5.8)/xx,y:=(ha*5.3)/xx
	Gui,1:Add, text, x%x% y%y%, Stunden
	;-
Gui, Color, silver
Gui,1:Font, s%fs10% normal,
	x:=(wa*9.0)/xx,y:=(ha*5)/xx,w:=(wa*2.6)/xx,h:=(ha*2.2)/xx
	Gui,1:Add, edit, x%x% y%y% w%w% h%h%  vSonnenEditMinuten hwndhSsonnenEditMinuten center, 02
	Gui, Add, UpDown, vSonnenEditMinutenUpDown Horz 16 Range01-59, 02									;		Wiederholen
	GuiControl,1:    MoveDraw, 		SonnenEditMinutenUpDown, 			% thisW(2.9)

	;-
Gui,1:Font, s%fs10% normal,
	x:=(wa*13.7)/xx,y:=(ha*5.3)/xx
...
;	GuiControl,1:    enable, 		ddl1
 PostMessage, 0x0153, -1, 20,, ahk_id %hDDL1%  ; Setzt die Höhe des Auswahlfeldes. 	; https://ahkde.github.io/docs/v1/lib/GuiControls.htm#DropDownList
...
;	GuiControl,1:    enable, 		ddl3
 PostMessage, 0x0153, -1, 20,, ahk_id %hDDL3%  ; Setzt die Höhe des Auswahlfeldes. 	; https://ahkde.github.io/docs/v1/lib/GuiControls.htm#DropDownList
;PostMessage, 0x0153,  0, 20,, ahk_id %hDDL3%  ; Setzt die Höhe jedes Listeneintrags.
; ////////////////////////////////////////////////////////////////////////////////////	
;Gui Add, DDL, vcbx w200 hwndhcbx, Eins||Zwei
; CB_SETITEMHEIGHT = 0x0153
;PostMessage, 0x0153, -1, 30,, ahk_id %hcbx%  ; Setzt die Höhe des Auswahlfeldes.
;PostMessage, 0x0153,  0, 30,, ahk_id %hcbx%  ; Setzt die Höhe jedes Listeneintrags.
...
; ////////////////////////////////////////////////////////////////////////////////////	button ListView (oben) AnsichErweitern
	...
	Gui,1:Add, button, vListViewAnsichErweitern hwndHListViewAnsichErweitern Hidden gListViewEinUndAusblenden
