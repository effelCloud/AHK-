...
;schriftFarbe := "blue"
if (schriftFarbe = "blue")
	GuiControl,1: 	+cBlue, 		GroupBoxUnterLOGListview
else
...
;schriftFarbe := "blue"
if (schriftFarbe = "blue")
	GuiControl,1: 	+cBlue, 		GroupBoxUnterListView1
else
...
; ////////////////////////////////////////////////////////////////////////////////////	text TextEdit1 TimeStamp
	...
	Gui,1: Font,							% thisZoomFactorBold(20.0111) " cBlue", Verdana ; zoomf (22.5111) (15.01) 
...
; 	https://www.autohotkey.com/board/topic/122519-listbox-with-a-different-width-for-the-drop-down/
	CB_SETDROPPEDWIDTH := 0x0160
	SendMessage, CB_SETDROPPEDWIDTH, 340, 0, , ahk_id  %hDDL1%
...
; ////////////////////////////////////////////////////////////////////////////////////	feiertage
	...
	if (thisFeiertagBundesland="by")
	thisFeiertage := feiertage(a_yyyy,"by","longdate") 	; by=Bayern alle 16
			, LVReihen = 8
	...
	Gui,1: Add, text , gLVfeiertageON vLVfeiertageON cBlack Hidden backgroundTrans
...
; LVfeiertage:
	...
	Gui,1: Add, listview ,% "r" ((reihenListViewFeiertage.length())-LVReihen) " NoSort vLVfeiertage gLVfeiertage  hwndhLVfeiertage grid cBlack Hidden background"  ListView1Color 
																, #|Feiertage %a_yyyy%|Wochentag|Datum - alle Bundesländer - 19 Feiertage
	_LVfeiertage_TT := "`nGui,1: Add, listview ,% ""r"" ((reihenListViewFeiertage.length())-LVReihen) "" vLVfeiertage gLVfeiertage  hwndhLVfeiertage grid cBlack Hidden background""  ListView1Color`n
																, #|Feiertage `%a_yyyy`%|Wochentag|Datum`n" 
																. a_space "a_LineNumber: " a_lineNumber
	Gui,1: Font,								% thisZoomFactorNormal(9.01)
	GuiControl,1:    MoveDraw, 		LVfeiertage,			% thisX(30.0) thisY(45.5) thisW(34.0)  thisH ; " r" ((reihenListViewFeiertage.length())) ;
...
;	GuiControl,1: ,  			TextInGroupBoxSonnenstunden,	%  thisFeiertage
...
;	thisFeiertagBundesland := thisMaxCount-Mod(thisMaxCount-Mod(aindexMODListViewFeiertage,thisMaxCount),thisMaxCount) ; zählt dauernd von 1 bis 19
	...
	thisFeiertage := feiertage(a_yyyy,"dl","longdate") 	; alle Bundesländer 19 Feiertage
			, LVReihen = 10, thisH := thisH(33.0) , Bundesland := "alle Bundesländer"
	...
	LV_Delete()
	Gui,1: Font,								% thisZoomFactorNormal(9.01)
	GuiControl,1:    MoveDraw, 		LVfeiertage,			% thisX(30.0) thisY(45.5) thisW(34.0) thisH
	GuiControl,1:    Font, 			LVfeiertage
	GuiControl,1:    show, 			LVfeiertage
;	GuiControl,1:    hide, 			LVfeiertage
...
;//////////////////////////////////////////////////////////////////////////////////// feiertage
/*
;22 func feiertagejahrlandtimestrg   und 2 weitere Seiten  Persönlich  Microsoft Edge
;22 func feiertagejahrlandtimestrg   und 2 weitere Seiten  Persönlich  Microsoft Edge
