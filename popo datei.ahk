...
; loopPtogress()							; 
; thisLoopPtogress, 
	Gui,1: Add, Progress,   BackgroundRed vthisLoopPtogress hwndHthisLoopPtogress
	Control ExStyle, -0x20000,, % "ahk_id" HthisLoopPtogress ; https://www.autohotkey.com/boards/viewtopic.php?p=279363#p279363 by Ragnar <> progress rahmenlos
	GuiControl,1:    MoveDraw, 		thisLoopPtogress,			% thisX(0) thisY(0) thisW(65) thisH(80) ;  default
	GuiControl,1:    hide, 			thisLoopPtogress
...
Loop, % items
{	
	GuiControl,1:, 	thisLoopPtogress, % Round(100 * A_Index / items)
Sleep, 30
}
...
;Gefahrenmeldung("xTrigger") ; test
 	 GuiControl,1:    show, 			thisLoopPtogress
 	 loopPtogress()
 	 GuiControl,1:    hide, 			thisLoopPtogress
return
