...
HrDelaySAmin := SUstd
	...
	MainArray["Zeit seit letztem SonnenuntergangHHMMSSMS"]	 := 	subStr(ConvertToHHMMSSMS(MainArray["Zeit seit letztem Sonnenuntergang"]),1,5) 	; 
	MainArray["Zeit seit letztem Sonnenaufgang"]	 := 	  ConvertToMilliseconds(A_Hour ":" A_Min ":" A_Sec "," A_MSec)
								- ConvertToMilliseconds(MainArray["thisCalendarDaySunRise",A_DD,A_MM] ":" 00 "`," 000)
	MainArray["Zeit seit letztem SonnenaufgangHHMMSSMS"]	 := 	subStr(ConvertToHHMMSSMS(MainArray["Zeit seit letztem Sonnenaufgang"]),1,5) 	; 
...
;	. "`nZeit seit letztem Sonnenaufgang:`t" MainArray["Zeit seit letztem SonnenaufgangHHMMSSMS"] ; debug
	...
	. "`nZeit seit letztem Sonnenaufgang:`t`t" MainArray["Zeit seit letztem SonnenaufgangHHMMSSMS"] ; debug
	...
	. "`nZeit seit letztem Sonnenuntergang:`t`t" MainArray["Zeit seit letztem SonnenuntergangHHMMSSMS"] ; debug
	} else {
		DayCounter++
